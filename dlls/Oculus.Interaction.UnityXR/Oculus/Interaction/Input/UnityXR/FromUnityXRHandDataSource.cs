...
public class FromUnityXRHandDataSource : FromOpenXRHandDataSource
{
	...
	[SerializeField]
	private InputActionMap _metaAimHandBindingsLeft = Enumerable.FirstOrDefault(InputActionMap.FromJson(_metaAimHandActionMap));

	[SerializeField]
	private InputActionMap _metaAimHandBindingsRight = Enumerable.FirstOrDefault(InputActionMap.FromJson(_metaAimHandActionMap.Replace("{LeftHand}", "{RightHand}")));
