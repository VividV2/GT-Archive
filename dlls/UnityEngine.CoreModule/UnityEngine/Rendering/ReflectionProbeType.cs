namespace UnityEngine.Rendering
{
	public enum PassType
	{
		...
		ForwardBase = 4,
		ForwardAdd = 5,
		[System.Obsolete("Deferred Lighting was removed, so LightPrePassBase pass type is never used anymore.")]
		LightPrePassBase = 6,
		[System.Obsolete("Deferred Lighting was removed, so LightPrePassFinal pass type is never used anymore.")]
		LightPrePassFinal = 7,
		ShadowCaster = 8,
		Deferred = 10,
		Meta = 11,
