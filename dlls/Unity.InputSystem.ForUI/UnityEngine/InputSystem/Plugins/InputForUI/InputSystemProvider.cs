...
internal class InputSystemProvider : IEventProviderImpl
{
	...
	private EventModifiers m_EventModifiers => m_InputEventPartialProvider._eventModifiers;
	...
	private (Vector2, bool) ReadCurrentNavigationMoveVector()
	{
		...
		Vector2 item = m_MoveAction.action.ReadValue<Vector2>();
		bool item2 = m_MoveAction.action.WasPressedThisFrame();
		return (item, item2);
	}
...
internal class UnitySourceGeneratedAssemblyMonoScriptTypes_v1
{
	...
	private static MonoScriptData Get()
	{
		return new MonoScriptData
		{
			...
			{
				0, 0, 0, 2, 0, 0, 0, 110, 92, 76,
				105, 98, 114, 97, 114, 121, 92, 80, 97, 99,
				107, 97, 103, 101, 67, 97, 99, 104, 101, 92,
				99, 111, 109, 46, 117, 110, 105, 116, 121, 46,
				105, 110, 112, 117, 116, 115, 121, 115, 116, 101,
				109, 64, 98, 101, 54, 99, 52, 102, 100, 48,
				97, 98, 102, 53, 92, 73, 110, 112, 117, 116,
				83, 121, 115, 116, 101, 109, 92, 80, 108, 117,
				103, 105, 110, 115, 92, 73, 110, 112, 117, 116,
				70, 111, 114, 85, 73, 92, 73, 110, 112, 117,
				116, 83, 121, 115, 116, 101, 109, 80, 114, 111,
				118, 105, 100, 101, 114, 46, 99, 115
			},
			TypesData = new byte[142]
			{
				0, 0, 0, 0, 62, 85, 110, 105, 116, 121,
				69, 110, 103, 105, 110, 101, 46, 73, 110, 112,
				117, 116, 83, 121, 115, 116, 101, 109, 46, 80,
				108, 117, 103, 105, 110, 115, 46, 73, 110, 112,
				117, 116, 70, 111, 114, 85, 73, 124, 73, 110,
				112, 117, 116, 83, 121, 115, 116, 101, 109, 80,
				114, 111, 118, 105, 100, 101, 114, 0, 0, 0,
				0, 70, 85, 110, 105, 116, 121, 69, 110, 103,
				105, 110, 101, 46, 73, 110, 112, 117, 116, 83,
				121, 115, 116, 101, 109, 46, 80, 108, 117, 103,
				105, 110, 115, 46, 73, 110, 112, 117, 116, 70,
				111, 114, 85, 73, 46, 73, 110, 112, 117, 116,
				83, 121, 115, 116, 101, 109, 80, 114, 111, 118,
				105, 100, 101, 114, 124, 65, 99, 116, 105, 111,
				110, 115
			},
			TotalFiles = 1,
			TotalTypes = 2,
