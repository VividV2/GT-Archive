...
namespace Oculus.Platform.Models
{
	public class LivestreamingApplicationStatus(IntPtr o)
	{
		public readonly bool StreamingEnabled = CAPI.ovr_LivestreamingApplicationStatus_GetStreamingEnabled(o);
	}
}
